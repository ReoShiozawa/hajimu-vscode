...
export const BUILTIN_FUNCTIONS: BuiltinInfo[] = [
    ...
    // 非同期
    { name: '非同期実行', description: '非同期でタスクを実行', signature: '非同期実行(関数, 引数...)', category: '非同期' },
    { name: '待機', description: 'タスクの完了を待つ', signature: '待機(タスク)', category: '非同期' },
    { name: '全待機', description: '全タスクの完了を待つ', signature: '全待機(タスク配列)', category: '非同期' },
    { name: 'タスク状態', description: 'タスクの状態を取得', signature: 'タスク状態(タスク)', category: '非同期' },
    { name: '並列実行', description: '並列でタスクを実行', signature: '並列実行(関数配列)', category: '非同期' },
    { name: '排他作成', description: 'ミューテックスを作成', signature: '排他作成()', category: '非同期' },
    { name: '排他実行', description: 'ミューテックスで排他実行', signature: '排他実行(ミューテックス, 関数)', category: '非同期' },
    // チャネル
    { name: 'チャネル作成', description: 'チャネルを作成', signature: 'チャネル作成(バッファサイズ?)', category: 'チャネル' },
    { name: 'チャネル送信', description: 'チャネルにデータを送信', signature: 'チャネル送信(チャネル, データ)', category: 'チャネル' },
    { name: 'チャネル受信', description: 'チャネルからデータを受信', signature: 'チャネル受信(チャネル)', category: 'チャネル' },
    { name: 'チャネル閉じる', description: 'チャネルを閉じる', signature: 'チャネル閉じる(チャネル)', category: 'チャネル' },
    // スケジューラ
